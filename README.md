...
The test suite reports thirty-two focused checks separately: peak discovery and refinement,
...
preservation of untouched fitted peaks, persistent/session-only custom-line restoration and removal, and
